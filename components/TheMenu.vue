...
const links = [
    { title: "صفحه اصلی", to: "/" },
    {
        ...
        subMenu: [
            { title: "تاپ چارت", to: "/top-chart" },
            { title: "معاونت راهبرد و توسعه کسب و کار ", to: "/architectures/راهبرد-و-توسعه-کسب-و-کار" },
            { title: "معاونت  مالی، اداری و پشتیبانی", to: "/architectures/مالی-اداری-و-پشتیبانی" },
            { title: "معاونت مشتریان تجاری و سازمانی", to: "/architectures/مشتریان-تجاری-و-سازمانی" },
            { title: "معاونت مشتریان خانگی", to: "/architectures/مشتریان-خانگی" },
            { title: "معاونت شبکه", to: "/architectures/شبکه" },
            { title: "معاونت فناوری اطلاعات", to: "/architectures/فناوری-اطلاعات" },
            { title: "معاونت تنظیم مقررات", to: "/architectures/تنظیم-مقررات" },
        ],
    },
    // {
