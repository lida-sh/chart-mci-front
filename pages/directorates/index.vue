<template>
  ...
  import type { ProcessBaseDto } from '~/composables/directorates/directorate.dto'
...
//   const processes = ref<ProcessBaseDto[]>([])
  ...
  const { data, pending, error, refresh } = await useLazyAsyncData('processes', () => getProcesses(query.value), { server:false })
