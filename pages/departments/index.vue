<template>
      ...
      <section class="px-4 py-10 rounded-lg bg-white shadow-lg w-full lg:w-[30rem]">
        ...
        <Form class="flex flex-col items-center justify-center w-full" >
          <div class="divide-y w-full">
            ...
            <div class="p-3">
              <app-select-input name="process_id" :options="directorates!" :label="$t('process_id')" class="sm:col-span-2"
  ...
  import { useGetBaseArchitecturesService, useGetBaseDirectoratesService, useGetProceduresService, useGetSubProcessesService } from '~/composables/home/home.service'
  ...
  const { data, pending, error, refresh } = await useLazyAsyncData('procedures', () => getSubProcesses(query.value), { })
